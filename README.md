...
```bash
dnx GroupDocs.Viewer.Mcp@26.7.2 --yes
```
...
> `"GroupDocs.Viewer.Mcp@26.7.2"` in `args`. Pinning is recommended for
...
> `"GroupDocs.Viewer.Mcp@26.7.2"` to lock to a specific release.
