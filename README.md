...
```bash
dnx GroupDocs.Viewer.Mcp@26.7.0 --yes
```
...
> `"GroupDocs.Viewer.Mcp@26.7.0"` in `args`. Pinning is recommended for
...
> `"GroupDocs.Viewer.Mcp@26.7.0"` to lock to a specific release.
